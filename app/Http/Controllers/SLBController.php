...
class SLBController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('slb.dashboard', compact('latest_entries', 'labels', 'data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // ]);
            // return redirect()->route('bschool.index')->with('success', 'Data berhasil ditambahkan');
            ...
            return redirect()->route('bschool.achievements')->with('success', 'store achievement:Data Berhasil Disimpan!');
    ...
    public function show(Request $request)
    {
        ...
        return view('slb.achievements',compact('acvs','school'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('slb.edit', compact('acvs'));
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('bschool.achievements')->with('success', 'update achievements:Data Berhasil Disimpan!');
    ...
    public function destroy(Request $request)
    {
        $acvs = Achievement::find($request->id);
        $acvs->delete();
        return redirect()->route('bschool.achievements')->with('success', 'delete admin:Data Berhasil Dihapus!');
    }
