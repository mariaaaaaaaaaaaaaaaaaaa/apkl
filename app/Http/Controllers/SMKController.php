...
class SMKController extends Controller
{
    ...
    public function index()
    {
        ...
        $chart = Achievement::select(Achievement::raw("COUNT(*) as count"), Achievement::raw("MONTHNAME(waktu) as month_name"))
                    ->join('users', function(JoinClause $join){
                        $join->on('users.npsn', '=', 'achievements.npsn')
                        ->where('users.npsn', '=', Auth::user()->npsn);
                    })
        ...
        return view('smk.dashboard', compact('latest_entries', 'labels', 'data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // ]);
            // return redirect()->route('kschool.index')->with('success', 'Data berhasil ditambahkan');
            ...
            return redirect()->route('kschool.achievements')->with('success', 'store achievement:Data Berhasil Disimpan!');
    ...
    public function show(Request $request)
    {
        ...
        return view('smk.achievements',compact('acvs','school'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('smk.edit', compact('acvs'));
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kschool.achievements')->with('success', 'update achievements:Data Berhasil Disimpan!');
    ...
    public function destroy(Request $request)
    {
        $acvs = Achievement::find($request->id);
        $acvs->delete();
        return redirect()->route('kschool.achievements')->with('success', 'delete admin:Data Berhasil Dihapus!');
    }
