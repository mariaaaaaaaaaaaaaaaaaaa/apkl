@extends('layouts.adminapp')
    ...
    @endif
    <div class="p-2">
        <h3 class="font-bold uppercase pb-2">Daftar Akun : Admin</h3><hr>
        <div class="pt-2 relative overflow-x-auto shadow-md sm:rounded-lg">
            <div class="grid grid-cols-2 gap-6 p-4 bg-white">
                <div class=" ">
                    <form action="{{ route('admin.users.admin') }}" method="GET" class="flex items-center">   
                ...
                <div class="inline-flex justify-end">
                    <a href="{{ route('admin.users.admin.create') }}" class="mx-3 px-2 flex py-3.5 btn md:mb-0 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm dark:bg-blue-600 dark:hover:bg-blue-700">Tambah Akun Baru</a>
                    <a href="{{ route('admin.users.admin.pdf') }}" class="px-2 flex md:mb-0 text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm py-3.5 dark:bg-blue-600 dark:hover:bg-blue-700">Cetak PDF</a>
                    ...
                    <div id="dropdownLeftEnd" class="z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownLeftEndButton">
                            <li><a href="{{ route('admin.users.admin.pdf') }}" class="block flex px-4 py-2 gap-3 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                        ...
                        @if (count($admins) > 0)
                            ...
                            @foreach($admins as $key=>$admin)
                                <tr class="border-b text-black dark:bg-gray-800 dark:border-gray-700 hover:bg-yellow-200 dark:hover:bg-gray-600 dark:text-white">
                                    ...
                                    {{-- <td class="px-6 py-4">{{ $admin->npsn }}</td> --}}
                                    ...
                                    <td class="flex items-center px-6 py-4 space-x-3">
                                        ...
                                        <button data-modal-target="defaultModal" data-item="{{ $admin->id }}" data-modal-toggle="defaultModal" type="button" class="font-medium text-red-600 dark:text-red-500 hover:underline">Hapus</button>
                                        <!-- Main modal -->
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-6 space-y-6">
                                                        <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                                            Apakah Anda yakin akan menghapus akun <strong class="uppercase">{{ $admin->name }}</strong> secara permanen?
                                                        </p>
                                                    </div>
                                                    <!-- Modal footer -->
