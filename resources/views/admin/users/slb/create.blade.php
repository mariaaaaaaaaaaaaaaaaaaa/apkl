    ...
    <section class=" ">
        <div class="font-bold border-b border-gray-200 dark:border-gray-700">
            <div class="text-base p-2">
                Buat Data Akun Baru SLB
            </div>
        </div>
        <div class="rounded-lg bg-white">
            <form action="{{ route('admin.users.slb.store') }}" method="POST" id="create_form" class="py-2">
                @csrf
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    {{-- <div class="px-2">
                        ...
                        <input type="text" name="role" id="role" value="SLB" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled readonly>
                    </div> --}}
                </div>
