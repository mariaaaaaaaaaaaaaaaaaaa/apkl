                ...
                {{-- <div class="px-2">
                    ...
                    <fieldset class="pl-2">
                        ...
                        <div class="flex items-center mb-2">
                            <input id="status" type="radio" name="status" value="0" {{ $smas->status == 0 ? 'checked' : ''}} class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                            <label for="status" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Aktif
                            </label>
                        </div>
                        <div class="flex items-center mb-2">
                            <input id="status" type="radio" name="status" value="1" {{ $smas->status == 1 ? 'checked' : ''}} class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                            <label for="status" class="block ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                Tidak Aktif
                            </label>
                        </div>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                                Apakah Anda yakin akan melakukan reset password pada akun <strong class="uppercase">{{ $smas->name }}</strong>?
                            </p>
                        </div>
                        <!-- Modal footer -->
                        <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="defaultModal" id="confirm-reset-btn" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                <a href="{{ route('admin.users.reset', ['id'=>$smas->id]) }}" id="confirm-reset-link" class="text-white">
                                Reset</a>
                            </button>
